...
local function makeWindow(options)
	...
	local function AddColorPicker(parentPage, text, defaultColor, callback, options)
		...
		colorPickerBtn.MouseButton1Click:Connect(function()
			...
			pickerFrame.Size = UDim2.new(0, 220, 0, 165)
			pickerFrame.Position = UDim2.new(0.5, -110, 0.5, -82)
			pickerFrame.BackgroundColor3 = Color3.fromRGB(32, 32, 36)
			...
			gradient.Size = UDim2.new(0, 200, 0, 90)
			gradient.Position = UDim2.new(0, 10, 0, 32)
			...
			hueSlider.Position = UDim2.new(0, 10, 0, 128)
			...
			thumb.Position = UDim2.new(hue, -5, 0.5, -9)
			thumb.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			...
			UserInputService.InputChanged:Connect(function(inp)
				if draggingHue and (inp.UserInputType == Enum.UserInputType.MouseMovement or inp.UserInputType == Enum.UserInputType.Touch) then
					local ax = hueSlider.AbsoluteSize.X
					if ax > 0 then
						local rel = (inp.Position.X - hueSlider.AbsolutePosition.X) / ax
			...
			gradient.InputBegan:Connect(function(inp)
				...
				local gx, gy = gradient.AbsoluteSize.X, gradient.AbsoluteSize.Y
				if gx > 0 and gy > 0 then
					local relX = (inp.Position.X - gradient.AbsolutePosition.X) / gx
					local relY = (inp.Position.Y - gradient.AbsolutePosition.Y) / gy
			...
			closeBtn.Position = UDim2.new(0.5, -35, 1, -36)
			closeBtn.Text = "Done"
