...
local function makeWindow(options)
	...
	closeButton.Text = "X"
	closeButton.BackgroundColor3 = Color3.fromRGB(38, 38, 44)
	...
	minimizeButton.Text = "—"
	minimizeButton.BackgroundColor3 = Color3.fromRGB(38, 38, 44)
	...
	tabHolder.BackgroundColor3 = Color3.fromRGB(24, 24, 28)
	...
	pageHolder.BackgroundColor3 = Color3.fromRGB(24, 24, 28)
	pageHolder.BackgroundTransparency = 0
	pageHolder.ZIndex = 6
	...
	-- Sidebar hover: expand tab column on mouse enter, collapse on leave
	local hoverConnections = {}
	local originalSidebarW = 45
	local expandedSidebarW = 160
	local minClamp = 45
	local currentSidebarW = originalSidebarW
	local sidebarGap = 10

	local function tweenSidebarWidth(toW)
		toW = math.clamp(toW, minClamp, expandedSidebarW)
		local tweenInfo = TweenInfo.new(0.25, Enum.EasingStyle.Sine, Enum.EasingDirection.Out)
		local t1 = TweenService:Create(tabHolder, tweenInfo, { Size = UDim2.new(0, toW, 1, -45) })
		local t2 = TweenService:Create(pageHolder, tweenInfo, {
			Position = UDim2.new(0, toW + sidebarGap, 0, 50),
			Size = UDim2.new(1, -(toW + sidebarGap), 1, -45)
		})
		t1:Play()
		t2:Play()
		t1.Completed:Connect(function()
			currentSidebarW = toW
			updateTabSizesForSidebar(toW)
		end)
	end
	...
	local function enableSidebarHover()
		...
		hoverConnections = {}
		table.insert(hoverConnections, tabHolder.MouseEnter:Connect(function()
			if isMinimized or isAnimating then return end
			tweenSidebarWidth(expandedSidebarW)
		end))
		table.insert(hoverConnections, tabHolder.MouseLeave:Connect(function()
			if isMinimized or isAnimating then return end
			tweenSidebarWidth(minClamp)
		end))
	end
	...
	local function updateTabSizesForSidebar(w)
		local expanded = w > originalSidebarW + 30
		for _, t in pairs(tabs) do
			local wrap = t.Wrap
			local label = t.NameLabel
			if wrap and label then
				if expanded then
					wrap.Size = UDim2.new(0, expandedSidebarW - 10, 0, 34)
					label.Visible = true
				else
					wrap.Size = UDim2.new(0, 30, 0, 30)
					label.Visible = false
				end
			end
		end
	...
	local function CreateTab(tabName, iconArg)
		...
		tabWrap.Name = tabName .. "TabWrap"
		tabWrap.Size = UDim2.new(0, 30, 0, 30)
		tabWrap.BackgroundTransparency = 1
		tabWrap.ClipsDescendants = true
		tabWrap.Parent = tabHolder
		tabWrap.ZIndex = 6
		...
		-- Tab name label (visible when sidebar expanded)
		local tabNameLabel = Instance.new("TextLabel")
		tabNameLabel.Name = "TabName"
		tabNameLabel.Size = UDim2.new(1, -38, 0, 20)
		tabNameLabel.Position = UDim2.new(0, 36, 0, 7)
		tabNameLabel.BackgroundTransparency = 1
		tabNameLabel.Text = tabName
		tabNameLabel.TextColor3 = Color3.fromRGB(180, 180, 190)
		...
		tabNameLabel.Parent = tabWrap
		tabNameLabel.ZIndex = 8

		-- SP Hub style: blue vertical bar on left when selected
		local tabBar = Instance.new("Frame")
		tabBar.Name = "SelectedBar"
		tabBar.Size = UDim2.new(0, 3, 1, 0)
		tabBar.Position = UDim2.new(0, 0, 0, 0)
		tabBar.BackgroundColor3 = Color3.fromRGB(0, 122, 255)
		tabBar.BorderSizePixel = 0
		tabBar.Visible = false
		tabBar.Parent = tabButton
		tabBar.ZIndex = 8
	...
	page.Visible = false
	page.BackgroundColor3 = Color3.fromRGB(24, 24, 28)
	page.BackgroundTransparency = 0
	page.BorderSizePixel = 0
	page.ScrollBarThickness = 4
	page.ScrollBarImageColor3 = Color3.fromRGB(90, 90, 100)
	page.ZIndex = 7
	...
	pageLayoutOrders[page] = 0
		...
		tabButton.BackgroundColor3 = Color3.fromRGB(28, 28, 32)
		tabButton.ImageColor3 = Color3.fromRGB(170, 170, 180)
	end)
	...
	tabButton.MouseButton1Click:Connect(function()
		...
		for _, t in pairs(tabs) do
			...
			t.Button.BackgroundColor3 = Color3.fromRGB(28, 28, 32)
			t.Button.ImageColor3 = Color3.fromRGB(140, 140, 150)
			local bar = t.Button:FindFirstChild("SelectedBar")
			if bar then bar.Visible = false end
		end
		page.Visible = true
		tabButton.BackgroundColor3 = Color3.fromRGB(38, 38, 42)
		tabButton.ImageColor3 = Color3.fromRGB(220, 220, 230)
		tabBar.Visible = true
		tabNameLabel.TextColor3 = Color3.fromRGB(220, 220, 230)
		for _, t in pairs(tabs) do
			local nl = t.NameLabel
			if nl and t.Button ~= tabButton then nl.TextColor3 = Color3.fromRGB(180, 180, 190) end
		end
		activeTab = tabName
	end)

		tabs[tabName] = { Button = tabButton, Page = page, Wrap = tabWrap, NameLabel = tabNameLabel }
	...
	local function AddButton(parentPage, text, callback, options)
		...
		btn.BackgroundColor3 = Color3.fromRGB(38, 40, 46)
		...
		btn.MouseEnter:Connect(function()
			btn.BackgroundColor3 = Color3.fromRGB(48, 50, 58)
		...
		btn.MouseLeave:Connect(function()
			btn.BackgroundColor3 = Color3.fromRGB(38, 40, 46)
			btn.BackgroundTransparency = 0.5
			btnStroke.Color = Color3.fromRGB(70, 70, 78)
		end)
	...
	local function AddToggle(parentPage, text, default, callback, options)
		...
		trackStroke.Color = Color3.fromRGB(60, 60, 68)
	...
	local function AddDropdown(parentPage, text, optionsList, defaultIndex, callback, options)
		...
		dropStroke.Color = Color3.fromRGB(65, 65, 72)
		dropStroke.Thickness = 1
		dropStroke.Parent = btn

		btn.MouseEnter:Connect(function()
			btn.BackgroundColor3 = Color3.fromRGB(48, 50, 58)
			btn.BackgroundTransparency = 0.35
			dropStroke.Color = Color3.fromRGB(85, 85, 92)
		end)
		btn.MouseLeave:Connect(function()
			btn.BackgroundColor3 = Color3.fromRGB(38, 40, 46)
			btn.BackgroundTransparency = 0.5
		...
		listFrame.BackgroundColor3 = Color3.fromRGB(32, 34, 40)
		...
		for i, opt in ipairs(optionsList) do
			...
			optBtn.BackgroundColor3 = Color3.fromRGB(40, 42, 48)
			...
			optBtn.MouseEnter:Connect(function()
				optBtn.BackgroundColor3 = Color3.fromRGB(52, 54, 62)
	...
	local function AddColorPicker(parentPage, text, defaultColor, callback, options)
		...
		colorPickerBtn.MouseEnter:Connect(function()
			previewStroke.Color = Color3.fromRGB(100, 100, 108)
		end)
		...
		colorPickerBtn.MouseButton1Click:Connect(function()
			...
			pickerStroke.Color = Color3.fromRGB(65, 65, 72)
			...
			topBar.BackgroundColor3 = Color3.fromRGB(32, 32, 36)
			...
			randomBtn.BackgroundColor3 = Color3.fromRGB(42, 42, 48)
			randomBtn.BackgroundTransparency = 0
	...
	local function AddTextbox(parentPage, text, placeholder, defaultText, callback, options)
		...
		boxStroke.Color = Color3.fromRGB(60, 60, 68)
	...
	local function toggleMinimize()
		...
		if not isMinimized then
			...
			tabHolder.Size = UDim2.new(0, originalSidebarW, 1, -45)
			pageHolder.Position = UDim2.new(0, originalSidebarW + sidebarGap, 0, 50)
			pageHolder.Size = UDim2.new(1, -(originalSidebarW + sidebarGap), 1, -45)
			currentSidebarW = originalSidebarW
	...
	-- Hide/show button: no image, just touch/mouse area to toggle window visibility
	local mainFrameHideShowButton = Instance.new("TextButton")
	...
	mainFrameHideShowButton.Text = ""
	mainFrameHideShowButton.BackgroundColor3 = Color3.fromRGB(38, 38, 44)
	mainFrameHideShowButton.BackgroundTransparency = 0
	...
	mainFrameHideShowButton.InputBegan:Connect(function(input)
		if input.UserInputType ~= Enum.UserInputType.MouseButton1 and input.UserInputType ~= Enum.UserInputType.Touch then return end
		if isAnimating then return end
	...
	-- Custom resize cursor when mouse over handle (SP Hub style)
	local cursorGui = Instance.new("ScreenGui")
	cursorGui.Name = "ResizeCursorGui"
	cursorGui.Parent = sc
	cursorGui.DisplayOrder = 9999
	cursorGui.IgnoreGuiInset = true
	cursorGui.ResetOnSpawn = false
	local cursorLabel = Instance.new("TextLabel")
	cursorLabel.Size = UDim2.new(0, 20, 0, 20)
	cursorLabel.BackgroundTransparency = 1
	cursorLabel.Text = "⤡"
	cursorLabel.TextColor3 = Color3.fromRGB(200, 200, 210)
	cursorLabel.TextSize = 16
	cursorLabel.Visible = false
	cursorLabel.Parent = cursorGui
	cursorLabel.ZIndex = 10000
	local cursorHover = false
	resizeHandle.MouseEnter:Connect(function()
		cursorHover = true
		cursorLabel.Visible = true
		resizeIcon.TextColor3 = Color3.fromRGB(180, 180, 190)
	end)
	...
	RunService.RenderStepped:Connect(function()
		if cursorHover and cursorLabel.Visible then
			local pos = UserInputService:GetMouseLocation()
			cursorLabel.Position = UDim2.new(0, pos.X + 8, 0, pos.Y + 8)
		end
	end)
	...
	for i = 1, 55 do
		...
		dot.BackgroundColor3 = Color3.fromRGB(110, 115, 130)
